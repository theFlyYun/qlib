...
4. 策略回测：[[TopK Strategy]]、[[Backtest And Costs]]、[[TopK Cost Backtest]]、[[PIT Safe Backtest]]、[[Future Information Audit]]、[[Future Leakage And Backtest Water Audit]]、[[Backtest Stress Test Review]]、[[Strict Re-Run Result Review]]、[[Benchmark And Excess Return Review]]、[[Position Contribution And Exposure Review]]
5. 数据扩展：[[Data Source Upgrade Plan]]、[[Strict PIT Data Repair Plan]]、[[CRSP Data Source Migration Plan]]、[[CRSP Early Stopping And Negative IC Diagnostics]]、[[CRSP Conservative Model And Horizon Comparison]]、[[CRSP Macro Conservative Comparison]]、[[CRSP Training Speed Optimization]]、[[CRSP Macro Interaction Ablation And Regime Review]]、[[CRSP Macro Enhanced Result Review]]、[[CRSP 2010 Baseline Cleanup And Industry Recovery]]、[[CRSP Industry Mapping Repair]]、[[CRSP EDGAR Fundamentals Integration]]、[[CRSP EDGAR Coverage Cleaning And Ablation]]、[[CRSP Rolling Window Validation]]、[[CRSP Rolling Window Failure Review]]、[[CRSP 2022 2023 Failure Deep Dive]]、[[CRSP Large Research Stage Summary]]、[[Databento Strict Launch PIT Integration]]、[[Sharadar Strict Launch PIT Integration]]、[[Fixed Window And Real EDGAR Runbook]]、[[Norgate Data Integration]]、[[SEC EDGAR Fundamentals Integration]]、[[SEC EDGAR Technical Data Flow]]、[[FRED ALFRED Macro Features Integration]]、[[FRED ALFRED Macro Experiment Review]]、[[Macro Features New Information And Return Degradation]]、[[Macro Regime Review And Interaction Features]]、[[Macro Interaction Ablation Review]]、[[Short History Evaluation And EDGAR Full Run]]、[[Stock Pool Cleaning And History Buckets]]、[[Security Master Data]]、[[Liquidity Filtering]]、[[Industry Features And Relative Ranking]]、[[Market Derived Relative Features]]、[[Data Scope And Sources]]、[[Financial Valuation Industry Macro News]]
6. 组合风控：[[Industry Neutralization]]、[[Industry Exposure Strategy Comparison]]、[[Industry Constraint Sensitivity]]、[[Within Sector Stock Selection Review]]、[[Sector Specific Error Review]]、[[Short History Score Calibration]]、[[Short History Stock Review]]、[[CRSP History Bucket Top10 And Industry Unknown Review]]、[[CRSP Industry Constraint And Relative Feature Recovery]]、[[CRSP Portfolio Construction And Risk Filter Repair]]、[[Portfolio Risk Control]]
7. Personal Quant：[[Personal Quant V1 Direction]]
8. 案例复盘：[[2026-05-17 Nasdaq Qlib Model]]、[[Sifang 601126 Case Study]]
